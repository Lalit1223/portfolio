    ...
    <div className="footer pt-5 text-white">
      <div className="container py-5">
          ...
          <div className="col-md-6">
            <div className="footer-text">
              ...
              <p>
                ...
                development and enjoy tackling complex problems with innovative
                solutions.
              </p>
            </div>
          </div>
        ...
        <div className="social-icons d-flex justify-content-center align-items-center pt-5">
          <a
            href="https://www.instagram.com/lalit.gandhi98"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/lalit-gandhi-79a1aa150/"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://github.com/Lalit1223"
            target="_blank"
            rel="noopener noreferrer"
          >
